...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdministrateurFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ApprenantFixtures($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\CMFixtures($b), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\CompetencesFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\FormateurFixtures($b), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\NiveauFixtures(($container->privates['App\\Repository\\CompetenceRepository'] ?? $container->load('getCompetenceRepositoryService'))), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\ProfilFixtures(), 'groups' => []], 8 => ['fixture' => new \App\DataFixtures\ProfilSortieFixtures(), 'groups' => []], 9 => ['fixture' => new \App\DataFixtures\PromoFixtures(($container->privates['App\\Repository\\ApprenantRepository'] ?? $container->load('getApprenantRepositoryService'))), 'groups' => []], 10 => ['fixture' => new \App\DataFixtures\ReferentielFixtures(($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())), 'groups' => []]]);
