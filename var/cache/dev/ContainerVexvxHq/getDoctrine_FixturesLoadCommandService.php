...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdministrateurFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ApprenantFixtures($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\CMFixtures($b), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\FormateurFixtures($b), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\ProfilFixtures(), 'groups' => []]]);
